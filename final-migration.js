...
// Manually define MONGODB_URI or read from .env if needed
const MONGODB_URI = 'mongodb://localhost:27017/tudo4mobile';
...
async function migrate() {
  try {
    ...
    // Clear existing products to avoid duplicates during this specific migration
